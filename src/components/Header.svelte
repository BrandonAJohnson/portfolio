...
<header class={'sticky z-[10] top-0 duration-200 px-6 flex items-center justify-between border border-solid ' + ((y > 0) ? ' py-4 bg-slate-950 border-slate-950 ' : ' py-6 bg-transparent border-transparent ')}>
	<h1 class="text-lg md:text-2xl lg:text-4xl"><img src='/images/me-transparent.png' alt='Brandon Johnson' class="h-20 w-20 inline-block"/> <b class="font-extrabold">Brandon</b> Johnson</h1>
	<div class="md:flex ml-auto pr-4 items-center gap-4 hidden">
		{#each tabs as tab, i}
	...
	<a href="mailto:brandonajohnson09@gmail.com" target="_blank" class="blueShadow relative overflow-hidden px-5 py-2 group rounded-full bg-blue-900 text-white">
